...
export function RiskGauge({ value }: { value: number }) {
  ...
  return (
    <div>
      <div className="relative h-2 border border-base-line bg-[linear-gradient(90deg,rgb(var(--color-rose))_0%,rgb(var(--color-amber))_42%,rgb(var(--color-mint))_100%)]">
        <span
  ...
  return (
    <div className="flex items-center gap-3">
      <div
        ...
        style={{
          background: `conic-gradient(rgb(var(--color-mint)) ${clamped * 3.6}deg, rgb(var(--color-raised)) 0deg)`
        }}
      >
...
export function RouteMiniTicket() {
  return (
    <div className="space-y-1.5">
      ...
      <div className="border border-base-amber/45 bg-base-amber/10 px-2 py-1.5 text-[11px] text-base-muted">
        ...
        <tbody>
          {events.map((event) => (
            <tr
              ...
              className="h-9 border-b border-base-line last:border-0"
            >
