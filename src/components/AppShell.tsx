  ...
  return (
    <div className="min-h-screen bg-base-black text-base-text">
      <header className="sticky top-0 z-40 border-b border-base-line/80 bg-base-black/95 backdrop-blur-xl">
        <div className="border-b border-base-line/50 bg-base-raised/45">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center rounded-lg border border-base-blue/55 bg-base-blue/20 text-base-electric shadow-glow">
          ...
          <div className="inline-flex w-fit items-center gap-2 rounded-lg border border-base-blue/35 bg-base-blue/12 px-3 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-base-electric">
